...
felizLunes.innerHTML = `¡Feliz ${diaSemana}! Hoy es 69-69-69 y son las 69:69`;
...
contadorBanner.innerHTML = "Quedan " + 69 + " días, " + 69 + " horas y " + 69 + " minutos para tu regalo";
...
function updateProgressBar() {
  ...
  progressIndicator.textContent = `69%`;
}
